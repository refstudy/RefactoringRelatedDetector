...
public class PushDownParser extends RefactoringParser {

    public PushDownParser(Refactoring ref) {
        super(RefactoringInstance.Type.PUSH_DOWN, ref);
    }
    ...
    public ImmutablePair<List<TreeASTNode<? extends ASTNode>>, List<TreeASTNode<? extends ASTNode>>> buildInstance(
        ...
        for (CodeRange rightSide : ref.rightSide()) {
            if (rightSide.getDescription().equals("pushed down method declaration")) {

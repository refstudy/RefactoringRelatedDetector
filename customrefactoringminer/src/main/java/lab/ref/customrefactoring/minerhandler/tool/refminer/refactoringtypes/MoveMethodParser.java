...
public class MoveMethodParser extends RefactoringParser {

    public MoveMethodParser(Refactoring ref) {
        super(RefactoringInstance.Type.MOVE_METHOD, ref);
    }
    ...
    public ImmutablePair<List<TreeASTNode<? extends ASTNode>>, List<TreeASTNode<? extends ASTNode>>> buildInstance(
        ...
        for (CodeRange rightSide : ref.rightSide()) {
            if (rightSide.getDescription().equals("moved method declaration")) {
